...
const EMAILJS_PUBLIC_KEY = 'MHTuMpIgA2rvum20m';
const EMAILJS_SERVICE_ID = 'service_6w9z3d5';
const EMAILJS_TEMPLATE_ID = 'template_lcqn61f';
const EMAILJS_NEWSLETTER_TEMPLATE_ID = 'template_qzh26hv'; // <-- replace with your actual Newsletter Template ID
